...
const formSchema = z
  ...
  .refine(
    ...
    {
      message: "Hora de início deve ser menor que hora de término",
...
export default function UpsertDoctorForm({ doctor, onSuccess }: UpsertDoctorFormProps) {
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      availableFromWeekDay: doctor?.availableFromWeekDay ? doctor.availableFromWeekDay.toString() : "1",
      availableToWeekDay: doctor?.availableToWeekDay ? doctor.availableToWeekDay.toString() : "5",
